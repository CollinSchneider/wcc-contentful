declare module 'contentful-ui-extensions-sdk' {
  ...
  */
  ...
  export interface ISpace { 
    getContentType(id: string): any,
    getContentTypes(): any[],
    createContentType(data: any): any,
    updateContentType(data: any): any,
    deleteContentType(data: any): any,


    getEntry(id: string): any,
    getEntries(query: any): any[],
    /** The content type is expected in data.sys.contentType */
    createEntry(data: any): any,
    updateEntry(data: any): any,
    publishEntry(data: any): any,
    unpublishEntry(data: any): any,
    archiveEntry(data: any): any,
    unarchiveEntry(data: any): any,
    deleteEntry(data: any): any,
    getPublishedEntries(query: any): any[],

    getAsset(id: string): any,
    getAssets(query: any): any[],
    /** The content type is expected in data.sys.contentType */
    createAsset(data: any): any,
    updateAsset(data: any): any,
    publishAsset(data: any): any,
    unpublishAsset(data: any): any,
    archiveAsset(data: any): any,
    unarchiveAsset(data: any): any,
    deleteAsset(data: any): any,
    getPublishedAssets(query: any): any[],
    processAsset(asset: any, locale: string): any
  } 
